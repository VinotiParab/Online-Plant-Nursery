<%-- 
    Document   : GardenAndAccessories
    Created on : Feb 18, 2019, 8:49:52 AM
    Author     : VINOTI
--%>
            ...
            <table align="center" cellspacing="10" style="width: 90%; height: 100%; font-size: 30px;">
                <%
                    try {
                        ...
                        PreparedStatement ps = con.prepareStatement("select * from product where category='Garden and Accessories'");
