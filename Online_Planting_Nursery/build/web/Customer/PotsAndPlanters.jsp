<%-- 
    Document   : PotsAndPlanters
    Created on : Feb 16, 2019, 4:38:28 PM
    Author     : VINOTI
--%>
            ...
            <table align="center" cellspacing="10" style="width: 90%; height: 100%; font-size: 30px;">
                <%
                    try {
                        ...
                        PreparedStatement ps = con.prepareStatement("select * from product where category='Pots and Planters'");
